...
["Fortune", "天谕·守", "天谕·攻", "卜命", "察体", "天运·避凶", "天运·趋吉", "探灵", "凶象", "天命·重现", "天命·飞逝", "吉运初显", "血光之灾", "诸事不宜", "天星·牵引", "天星·御心", "万事如意", "天机·顺应", "天机·逆施", "厄劫缠身", "命运轮回", "天运·避", "上命", "牵引", ],
]
Sidejob_pos=[
...
["sp43", "洗髓丹", "弱体符", "同心曲", "落纸云烟", "不动金刚阵", "冰封雪莲", "天星·牵引", "天星·御心", "牵引", ],
